...
import com.zzwloves.netty.ServerHttpRequest;
...
class WebSocketServerHandShakeHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
	 ...
	 * 构造
	 * @author zhengwei.zhu
	 * @param webSocketServerConfig
	 */
	public WebSocketServerHandShakeHandler(WebSocketServerConfig webSocketServerConfig) {
		this.webSocketServerConfig = webSocketServerConfig;
		this.webSocketHandler = webSocketServerConfig.getWebSocketHandler();
	}
	...
	protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg)
		...
		// 握手拦截
		HandshakeInterceptorChain interceptorChain = this.webSocketServerConfig.getInterceptorChain();
